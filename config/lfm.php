...
return [
    ...
    'middlewares'           => ['web', 'App\Http\Middleware\FileBrowser'],
    ...
    'images_dir'            => 'public/assets/media/images/',
    'images_url'            => '/assets/media/images/',

    'files_dir'             => 'public/assets/media/files/',
    'files_url'             => '/assets/media/files/',
