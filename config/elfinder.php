...
return array(
    ...
    |
    */
    'dir' => ['assets/media/images/news'],//'assets/media'
    ...
    */
    ...
    'route' => [
        ...
        'middleware' => ['web', 'App\Http\Middleware\FileBrowser'], //Set to null to disable middleware filter ['web', 'App\Http\Middleware\FileBrowser']
    ...
    */
    ...
    'options' => [
        'startPath' => 'assets/media/images/',
        'driver' => 'LocalFileSystem',
        'path'   => '/assets/media/image/',
        'URL'    => 'http://vieclamnongnghiep.vn/assets/media/image/',
        'bind' => array(
