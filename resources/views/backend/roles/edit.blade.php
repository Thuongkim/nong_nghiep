...
@section('title')
    {!! trans('system.action.edit') !!} {!! trans('roles.label') !!}
@stop
@section('content')
    ...
    <section class="content">
        ...
        {!! Form::open(array('url' => route('admin.roles.update', $role->id), 'method' => 'PUT', 'role' => 'form' )) !!}
            <table class='table borderless'>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        {!! Form::textarea('description', old('description', $role->description), array('class' => 'form-control tinymce', 'rows' => 2)) !!}
                    </td>
                </tr>
            </table>
            <div class="row">
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class='form-actions text-center'>
                            <a class="btn btn-default btn-flat" href="{!! route('admin.roles.index') !!}">{!! trans('system.action.cancel') !!}</a>
