...
@section('title')
{!! trans('system.action.list') !!} {!! trans('experiences.label') !!}
@stop
@section('content')
...
<section class="content overlay">
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            {!! Form::open([ 'url' => route('admin.experiences.index'), 'method' => 'GET', 'role' => 'search' ]) !!}
            <div class="row">
                <div class="col-md-2">
    ...
    <div class="row">
        <div class="col-md-2" style='float: left;'>
            <a href="{!! route('admin.experiences.create') !!}" class='btn btn-primary btn-flat'>
    ...
    <div class="box">
        <div class="box-body no-padding">
            <table class='table table-striped table-bordered tree'>
                <thead>
                    <tr>
                        <th style="text-align: center; vertical-align: middle;"> {!! trans('experiences.image') !!} </th>
                        <th style="vertical-align: middle;"> {!! trans('experiences.fullname') !!} </th>
                    ...
                    @foreach ($experiences as $item)
                        <tr>
                            ...
                            <td style="text-align: justify; vertical-align: middle;">
                                <a href="{!! route('admin.experiences.show', $item->id) !!}" title="{!! trans('system.action.detail') !!}">
                                    {!! $item->fullname !!}
                                </a>
                            </td>
                            <td  style="text-align: center; vertical-align: middle;">
                                @if($experiences->count() > 1)
                                    @if($item->position == 1)
                                        <a href="{{ route('admin.experiences.update-position', [$item->id, 1]) }}" title="{{ trans('system.down') }}">
                                            <i class="glyphicon glyphicon-circle-arrow-down"></i>
                                        </a>
                                    @elseif( $item->position == $experiences->count() )
                                        <a href="{{ route('admin.experiences.update-position', [$item->id, -1]) }}" title="{{ trans('system.up') }}">
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                <a href="{!! route('admin.experiences.edit', $item->id) !!}" class="btn-edit edit text-warning">
                                    <i class="glyphicon glyphicon-edit"></i>
                                    {!! trans('system.action.edit') !!}
                                </a>
                                &nbsp;
                                <a style="cursor: pointer;" link="{!! route('admin.experiences.destroy', $item->id) !!}" class="btn-confirm-del text-danger"><i class="glyphicon glyphicon-remove"></i> {!! trans('system.action.delete') !!} </a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
