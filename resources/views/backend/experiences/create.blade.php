...
@section('title')
    {!! trans('system.action.create') !!} - {!! trans('experiences.label') !!}
@stop
...
@section('content')
    ...
    @endif
    {!! Form::open(array('url' => route('admin.experiences.store'), 'role' => 'form', 'files' => true)) !!}
        ...
        <table class='table borderless'>
            <tr>
                ...
                <td style="width: 35%;">
                    {!! Form::text('fullname', old('fullname'), array('class' => 'form-control', 'maxlength' => 50, 'required')) !!}
                </td>
            ...
            <tr>
                ...
                <td>
                    {!! Form::text('phone', old('phone'), array('class' => 'form-control', 'maxlength' => 12)) !!}
                </td>
                <th class="text-right">
            ...
            <tr>
                ...
                <td>
                    {!! Form::textarea('content', old('content'), array('class' => 'form-control', 'maxlength' => 1024, 'rows' => 5)) !!}
                </td>
            </tr>
            <tr>
