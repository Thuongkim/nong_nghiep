...
@section('title')
    {!! trans('system.action.create') !!} {!! trans('users.label') !!}
@stop
@section('head')
...
@section('content')
    ...
    <section class="content">
        ...
        {!! Form::open(array('url' => route('admin.users.store'), 'user' => 'form' )) !!}
            <div class="table-responsive">
                <table class='table borderless'>
                    ...
                    <tr>
                        ...
                        <td>
                            {!! Form::input("password", "re_password", old("re_password"), ['class' => 'form-control', 'required']) !!}
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            {!! Form::text("info", old("info"), ['class' => 'form-control']) !!}
                        </td>
                    </tr>
                </table>
            </div>
