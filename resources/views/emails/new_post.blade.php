                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="padding-copy">
                                        <p>Cám ơn bạn đã gửi bài viết cho <a href="http://vicloud.vn/community">cộng đồng</a><span style="color: #3193cf; font-weight: bold;"> VICLOUD.VN!</span></p>
                                        <p><span style="color:#3193cf;font-weight:bold;">VICLOUD.VN</span> sẽ phản hồi sớm thông tin bài viết của bạn.</p>
                                        <p>Tiêu đề: <b>{!! $news->title !!}</b></p>
                                        <p>Ngày tạo: <b>{!! date("d/m/Y H:i", strtotime($news->created_at)) !!}</b></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 25px 0 0 0;" class="padding-copy">
                                                    <table border="0" cellspacing="0" cellpadding="0" class="responsive-table">
                                                        <tr>
                                                            <td align="left">
                                                                <p>Bạn có thể review và chỉnh sửa bài viết của mình <a href="{!! route('admin.news.edit', $news->id) !!}">tại đây</a> hoặc theo link chi tiết: {!! route('admin.news.edit', $news->id) !!}.</p>
