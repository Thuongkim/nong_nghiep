                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="padding-copy">
                                        <p><b>{!! $user->fullname !!}</b>, có một số bài dịch có thể phù hợp với chuyên môn của bạn!</p>
                                        <p style="padding:10px 0px;">
                                            <a href="{!! route('admin.hub-links') !!}" title="" style="display: inline-block; padding: 10px 25px; background: #287EC2; text-transform: uppercase; color: #fff; text-decoration: none; border-radius: 4px; font-size: 14px;">Truy cập ngay</a>
                                            <p>để nhận bài hoặc</p>
