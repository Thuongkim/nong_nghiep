                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="padding-copy">
                                        <p><b>{!! $user->fullname !!}</b>, @if ($user->last_login == null) chúng tôi nhớ bạn! @else lâu rồi bạn chưa đăng nhập vào hệ thống! @endif</p>
                                        <p>Chúng tôi đang có nhiều thông tin hấp dẫn dành cho bạn.</p>
                                        <p style="padding:10px 35px;">
                                            <a href="{!! route('admin.login') !!}" title="" style="display: inline-block; padding: 10px 25px; background: #287EC2; text-transform: uppercase; color: #fff; text-decoration: none; border-radius: 4px; font-size: 14px;">Đăng nhập ngay</a>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
