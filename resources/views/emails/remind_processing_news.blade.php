                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="padding-copy">
                                        <p><b>{!! $user->fullname !!}</b>, lâu rồi chúng tôi chưa nhận được thông tin từ bài viết: "{!! $name !!}" của bạn.</p>
                                        <p>Bạn đang gặp khó khăn gì, hãy liên hệ với chúng tôi bằng cách</p>
                                        <p style="padding:10px 0px;">
                                            <a href="https://www.facebook.com/messages/t/vicloud.vn" title="" style="display: inline-block; padding: 10px 25px; background: #287EC2; text-transform: uppercase; color: #fff; text-decoration: none; border-radius: 4px; font-size: 14px;">Gửi tin nhắn</a>
                                            <p>Hoặc</p>
                                            <a href="{!! route('admin.login') !!}" title="" style="display: inline-block; padding: 10px 25px; background: #287EC2; text-transform: uppercase; color: #fff; text-decoration: none; border-radius: 4px; font-size: 14px;">Đăng nhập ngay</a><p>để gửi bài dịch cho chúng tôi.</p>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 25px 0 0 0;" class="padding-copy">
                                                    <table border="0" cellspacing="0" cellpadding="0" class="responsive-table">
                                                        <tr>
                                                            <td align="left">
                                                                <p>Nếu bạn cần thêm thông tin chi tiết vui lòng liên hệ với BQT theo số <a href="tel:02466883355">024 6688 3355</a>.</p>
