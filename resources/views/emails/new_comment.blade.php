                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="padding-copy">
                                        @if(is_null($creator))
                                            <p>{!! $user->fullname !!} đã thêm tin nhắn cho bài viết của mình</p>
                                        @else
                                            <p>[QTV] {!! $user->fullname !!} đã gửi bạn tin nhắn mới</p>
                                        @endif
                                        <p>Nội dung: {!! $comment->content !!}</p>
                                        <p>Vào lúc: <b>{!! date("d/m/Y H:i", strtotime($comment->created_at)) !!}</b></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 25px 0 0 0;" class="padding-copy">
                                                    <table border="0" cellspacing="0" cellpadding="0" class="responsive-table">
                                                        <tr>
                                                            <td align="left">
                                                                <p>Bạn có thể xem tin nhắn đã gửi của bài viết <a href="{!! route('admin.news.show', $news->id) !!}">tại đây</a> hoặc theo link chi tiết: {!! route('admin.news.show', $news->id) !!}.</p>
