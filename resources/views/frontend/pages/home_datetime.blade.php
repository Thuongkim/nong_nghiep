		        		...
		        		<div class="col-sm-4">
			                <div class="pro-inner">
			                    ...
			                    <div class="pro-info">
			                        ...
			                        <div class="box_time">
			                        	<span><i class="fa fa-clock-o"></i>{!! \App\Helper\HString::timeElapsedString(strtotime($top4Categories[0]['news'][$i]['updated_at'])) !!}</span>
		                            	<span><i class="fa fa-commenting-o"></i>{!! $top4Categories[0]['news'][$i]['count_comment'] !!}</span>
			                        </div>
		            ...
		            <div class="col-sm-6">
		                ...
		                <div class="content_item">
		                    ...
		                    <div class="post_title_excerpt">
		                        <div class="box_time">
		                            <span><i class="fa fa-clock-o"></i>{!! \App\Helper\HString::timeElapsedString(strtotime($top4Categories[1]['news'][0]['updated_at'])) !!}</span>
		                            <span><i class="fa fa-commenting-o"></i>{!! $top4Categories[1]['news'][0]['count_comment'] !!}</span>
		                        </div>
		                        <div class="title">
		                            <a class="post-title"
		            	...
		            	@if (count($top4Categories[1]['news']) > 1)
		            		@for ($i = 1; $i < count($top4Categories[1]['news']) && $i < 4; $i++)
				                <div class="content_item addstyle">
				                    ...
				                    <div class="post_title_excerpt">
				                        <div class="box_time">
				                            <span><i class="fa fa-clock-o"></i>{!! \App\Helper\HString::timeElapsedString(strtotime($top4Categories[1]['news'][$i]['updated_at'])) !!}</span>
				                            <span><i class="fa fa-commenting-o"></i>{!! $top4Categories[1]['news'][$i]['count_comment'] !!}</span>
				                        </div>
				                        <div class="title">
				                            <a class="post-title"
		            	...
		            	@if (count($top4Categories[2]['news']))
		            		@for ($i = 0; $i < count($top4Categories[2]['news']) && $i < 2; $i++)
				                <div class="content_item addstyle">
				                    ...
				                    <div class="post_title_excerpt">
				                        <div class="box_time">
				                            <span><i class="fa fa-clock-o"></i>{!! \App\Helper\HString::timeElapsedString(strtotime($top4Categories[2]['news'][$i]['updated_at'])) !!}</span>
				                            <span><i class="fa fa-commenting-o"></i>{!! $top4Categories[2]['news'][$i]['count_comment'] !!}</span>
				                        </div>
				                        <div class="title">
				                            <a class="post-title"
		            	...
		            	@if (count($top4Categories[3]['news']))
		            		@for ($i = 0; $i < count($top4Categories[3]['news']) && $i < 4; $i++)
				                <div class="content_item addstyle">
				                    ...
				                    <div class="post_title_excerpt">
				                        <div class="box_time">
				                            <span><i class="fa fa-clock-o"></i>{!! \App\Helper\HString::timeElapsedString(strtotime($top4Categories[3]['news'][$i]['updated_at'])) !!}</span>
				                            <span><i class="fa fa-commenting-o"></i>{!! $top4Categories[3]['news'][$i]['count_comment'] !!}</span>
				                        </div>
				                        <div class="title">
				                            <a class="post-title"
		            	...
		            	@if (count($top4Categories[5]['news']))
		            		@for ($i = 0; $i < count($top4Categories[5]['news']) && $i < 4; $i++)
				                <div class="content_item addstyle">
				                    ...
				                    <div class="post_title_excerpt">
				                        <div class="box_time">
				                            <span><i class="fa fa-clock-o"></i>{!! \App\Helper\HString::timeElapsedString(strtotime($top4Categories[5]['news'][$i]['updated_at'])) !!}</span>
				                            <span><i class="fa fa-commenting-o"></i>{!! $top4Categories[5]['news'][$i]['count_comment'] !!}</span>
				                        </div>
				                        <div class="title">
				                            <a class="post-title"
