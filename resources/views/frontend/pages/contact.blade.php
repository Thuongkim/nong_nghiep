...
@section('title'){!! trans('system.contact') !!}@stop
@section('head')
<style type="text/css">
    ...
    <div class="container">
        <div class="drection">
            <div class="link">
                ...
                <span class="">{!! trans('system.contact') !!}</span>
            </div>
        </div>
    </div>
@stop
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="excerpt-cate">
                        <h1 class="title_cate"><img src="{!! asset('assets/frontend/images/icon_news.png') !!}"><span>{!! trans('system.contact') !!}</span>
                        </h1>
                    </div>
                    ...
                    <div class="form-contact">
                        ...
                        <div class="box_form_about">
                            <p class="title_from">Cảm ơn bạn đã ghé thăm, vui lòng để lại thông tin để chúng tôi có thể hỗ trợ bạn!
                            </p>
                            @if (session('message'))
                                <p class="text-danger">{!!  session('message') !!}</p>
                            @endif
                            {!! Form::open(['url' => route('home.postContact'), 'class' => "form_about has-validation-callback", 'id' => "form-contact"]) !!}
                                <div class="row">
                                ...
                                <div class="form-group">
                                    {!! Form::textarea('content', old('content'), ["class" => "form-control", 'placeholder' => trans('feedbacks.content'), 'rows' => 3, 'maxlength' => 1024, 'required']) !!}
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-danger btn-send" style="cursor: pointer">Gửi</button>
                                    </div>
                                    <div class="col-sm-6">
                                    </div>
                                </div>
