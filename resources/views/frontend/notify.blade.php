...
@section('title'){!! trans('system.info') !!}@stop
@section('head')
<style type="text/css">
    ...
    <div class="container">
        <div class="drection">
            <div class="link">
                ...
                <span class="">{!! trans('system.info') !!}</span>
            </div>
        </div>
    </div>
@stop
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="excerpt-cate">
                        <h1 class="title_cate"><img src="{!! asset('assets/frontend/images/icon_news.png') !!}"><span>{!! trans('system.info') !!}</span>
                        </h1>
                    </div>
                    <div class="form-contact">
                    	<div class="contact-info">
                    		<p><span style="font-size:18px">{!! session('message') ? session('message') : trans('system.success') !!}</span></p>
                    		<p>Hệ thống sẽ tự quay về <a href="{!! route("home") !!}">{!! trans('system.home') !!} </a> sau <span class="text-danger" id="counter">8 </span> giây</p>
                    	</div>
                    </div>
                </div>
            </div>
        ...
        !function ($) {
            $(function(){
                ...
                var looper = setInterval(function(){
                    counter++;
                    $("#counter").html('').append( senconds-counter );
                    if (counter == senconds) {
